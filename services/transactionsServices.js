import { deleteTransactionsModels, findAllTransactionsModels, findTransactionsByIdModels, findTransactionsByUserIdModels, findTransactionsByWalletIdModels, insertTransactionsModels } from "../models/transactionsModels.js";
...
export const insertTransactionsServices = async (walletId, categoryId, accountId, type, amount, description, date) => {
    try {
        const result = await insertTransactionsModels(walletId, categoryId, accountId, type, amount, description, date);
