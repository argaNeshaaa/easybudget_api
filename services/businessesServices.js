import { deleteBusinessesModels, findAllBusinessesModels, findBusinessesByIdModels, findBusinessesByUserIdModels, insertBusinessesModels, updateBusinessesModels } from "../models/businessesModels.js";
...
export const insertBusinessesServices = async (userId, name, industry, address) => {
    try {
        const result = await insertBusinessesModels(userId, name, industry, address);
